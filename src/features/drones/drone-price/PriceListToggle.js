...
const PriceListToggle = ({ isMobile, brandName, langPrefix, productType = 'drone' }) => {
  ...
  const getHeading = () => {
    ...
    if (productType === 'drone') {
      return langPrefix === 'hi'
        ? `भारत में लोकप्रिय ${brandName} ड्रोन्स प्राइस लिस्ट ${year}`
        : `Popular ${brandName} drones Price List ${year} in India`;
    }
