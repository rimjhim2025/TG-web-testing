...
const DronePriceBannerClient = ({ currentLang, translation }) => {
  ...
  return (
    <>
      <div
        className="hover:shadow-lg flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg bg-white shadow-main transition-shadow duration-200"
        onClick={handleBannerClick}
      >
        <img
          src="https://images.tractorgyan.com/uploads/120725/68ab2252520b5-Drone-Banner.webp"
...
export default DronePriceBannerClient;
