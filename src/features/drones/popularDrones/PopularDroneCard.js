      ...
      {isMobile ? (
              ...
              >
                ...
                >
                  <Image
                    ...
                    // }
                    src={`https://images.tractorgyan.com/uploads/117923/67ac809597219-garuda-aerospace-droni-drone.webp`}
        ...
        <div className="col-span-4 md:col-span-2 xl:col-span-1">
          <div className="flex h-full flex-col justify-between rounded-2xl border-[1px] border-gray-gainsboro bg-white p-5 hover:border-secondary hover:bg-green-lighter">
            ...
            <div className="flex justify-between rounded-lg bg-green-mint px-4 py-1.5">
              <div className="text-center">
                <h6 className="text-xs font-normal text-gray-dark">{translation.headings.speed}</h6>
              ...
              <div className="mx-1 border-x-[1px] border-primary px-2 text-center">
                <h6 className="text-xs font-normal text-gray-dark">{translation.headings.capacity}</h6>
                <p className="text-xs font-bold">3 acres per battery charge</p>
              </div>
              <div className="text-center">
...
export default PopularDroneCard;
