...
const DronePriceInquireForm = ({
  ...
  useEffect(() => {
    ...
    if (preFilledModelId) {
      setProductId(preFilledModelId);
    }
  }, [preFilledBrand, preFilledModel, preFilledModelId]);
            ...
            <div className="w-full overflow-hidden rounded-2xl shadow-main lg:max-w-[calc(100%_-_270px)] xl:max-w-[982px]">
              {!hideBanner && (
                ...
                >
                  <Image
                    ...
                    height={500}
                    width={500}
                    alt="drone price banner"
                    title="drone Price Banner"
              ...
              <div className={`${bgColor} p-4 md:p-8`}>
                ...
                <div className="mb-4 text-center text-sm font-normal text-black md:mb-10">
                  <span>
                    {console.log("DRONEDRONE _________________", type)}
                    {type === 'TRACTOR'
                      ? translation.enquiryForm.tractorTextForOtp
                      : type === 'IMPLEMENT'
                        ? translation.enquiryForm.implementTextForOtp || translation.enquiryForm.textForOtp
                        : type === 'DRONE'
                          ? translation.enquiryForm.droneTextForOtp || translation.enquiryForm.textForOtp
                          : translation.enquiryForm.tyreTextForOtp || translation.enquiryForm.textForOtp}
                  </span>
                </div>
                      ...
                      {type === 'TYRE'
                        ...
                        : type === 'TRACTOR'
                          ...
                          : type === 'IMPLEMENT'
                            ...
                            : type === 'DRONE'
                              ? translation.enquiryForm.droneBrand
                      ...
                      {type === 'TYRE'
                        ...
                        : type === 'TRACTOR'
                          ...
                          : type === 'IMPLEMENT'
                            ...
                            : type === 'DRONE'
                              ? translation.enquiryForm.droneModel
                        ...
                        {isSubmitting
                          ...
                          : submitBtnText
                            ...
                            : type === "TRACTOR"
                              ...
                              : type === "DRONE"
                                ? `₹ ${translation.enquiryForm.getDronePrice || "Get Drone Price"}`
                                : `₹ ${translation.enquiryForm.getTyrePrice || "Get Tyre Price"}`}
                      </span>
...
export default DronePriceInquireForm;
