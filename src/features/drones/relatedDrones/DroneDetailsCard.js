...
const DroneDetailsCard = ({
  ...
  // Mapping ratings to star image URLs
  const starImages = {
  ...
  const starImage = starImages[rating] || ''; // Fallback if rating is invalid
  ...
  const getModeSpecificContent = () => {
    switch (mode) {
      ...
      case 'drone':
        return {
          feature1Label: 'Speed',
          feature2Label: 'Capacity',
          buttonText: 'View Drone Price',
        };
      default: // tyre
        return {
          feature1Label: 'Size',
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-[128px] w-2/5 max-w-[183px] items-center justify-center md:mb-3 md:w-full">
        ...
        >
          <Image
            ...
            src={`https://images.tractorgyan.com/uploads/117923/67ac809597219-garuda-aerospace-droni-drone.webp`} height={500}
            width={500}
      ...
      <div className="w-3/5 md:flex md:min-h-[150px] md:w-full md:flex-col md:justify-end">
        <div className="mb-3">
          <Link
            href={pageUrl || '/'}
        ...
        <div className="mb-3 flex items-center gap-1.5">
          ...
          {featureItem(feature1Label, speed)}
          {featureItem(feature2Label, capacity)}
        </div>
