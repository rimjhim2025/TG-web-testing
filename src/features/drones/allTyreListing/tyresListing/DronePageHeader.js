...
const DronePageHeader = ({
  ...
  const headingTitle = heading
    ...
    : (translation?.headings?.topDronesinIndia).replace('{brand}', brandName);
  return (
    <>
      <div className="mb-4 flex flex-col items-start justify-between md:mb-6 md:flex-row md:items-center">
        ...
        <div className="flex w-full gap-2 md:block md:w-[40%]">
          ...
          <div className="max-w-[80px]">
            {isMobile && <DronesListingClient {...tyresListingClientProps} />}
          </div>
        </div>
...
export default DronePageHeader;
