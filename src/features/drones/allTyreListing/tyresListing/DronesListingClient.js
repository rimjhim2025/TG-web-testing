    ...
    <div className="w-full md:sticky md:top-0 md:min-h-screen">
      ...
      {isFilterPanelVisible && (
        <>
                ...
                <div className="mb-2 md:mb-6">
                  ...
                  <div className="flex flex-wrap gap-2 xl:gap-4">
                    {tractorHPs.map((hp, index) => (
                      <span
                        key={index}
                        className={`w-[30%] cursor-pointer rounded-full border-[1px] border-gray-light px-1.5 py-2 text-center text-xs hover:border-primary ${selectedHPRange === hp.page_url ? 'bg-primary text-white' : 'text-black'
                          } text-nowrap`}
                ...
                <div className="mb-2 md:mb-6">
                  ...
                  <div className="flex flex-wrap gap-2 xl:gap-4">
                    {(showAllBrands ? tyreBrands : tyreBrands.slice(0, 12)).map((brand, index) => (
                      <span
                        key={index}
                        className={`w-[30%] cursor-pointer rounded-full border-[1px] border-gray-light px-1.5 py-2 text-center text-xs sm:w-[23%] md:w-[47%] xl:w-[30%] ${selectedBrand === brand.name ? 'bg-primary text-white' : 'text-black'
          ...
          {showDroneBrandsSection && !isMobileViewProp && (
            // {true && (
            <div className="flex flex-wrap">
              <DroneByBrands
...
export default DronesListingClient;
