          ...
          <div className="flex flex-wrap gap-4 lg:gap-3 xl:gap-4">
            {initialTyres.map((tyre, index) => (
              <ListingCard
                ...
                // imgUrl={tyre.images}
                imgUrl={'118073/67bc9efa74fbe-fuselage-innovation-fia-qd10.webp'}
                tyreSize={tyre.tyre_size}
                tyreType={tyre.tyre_type}
                tyreUrl={tyre.tyre_url}
                pageUrl={'/drone/garuda-aerospace/kisan-drone-16l'} // Ensure this is correctly used or removed if redundant
