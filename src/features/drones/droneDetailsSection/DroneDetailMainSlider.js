// ============ Used At ============
// 1. /drone/garuda-aerospace/kisan-drone-16l
// 2.
// =================================
...
const DroneDetailMainSlider = ({ imgUrl, brandLogo, popularTyre, title }) => {
        ...
        <div className="slider-container hello">
          ...
          <div className="relative w-full">
            <div className="flex w-full items-start justify-between">
              <Image
                src='https://images.tractorgyan.com/uploads/drone-brand-logo/1739167426garuda-aerospace-webp-logos.webp'
                // src={brandLogo}
                height={100}
                width={100}
...
export default DroneDetailMainSlider;
