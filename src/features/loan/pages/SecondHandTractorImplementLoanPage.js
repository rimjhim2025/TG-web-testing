...
export default async function SecondHandTractorImplementLoanPage({ propsPrefLang }) {
  ...
  return (
    <>
      ...
      <main className="lg:mt-[159px]">
        ...
        <LoanFinanceSchemes title={translation?.loan?.secondHandImplementLoanFinanceSchemes} />
