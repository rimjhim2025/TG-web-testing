      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="mt-2">
            <input
              ...
              className={`ease w-full rounded-md border ${
                formErrors.name ? 'border-error-main' : 'border-gray-light'
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <input
              ...
              type="tel"
              className={`ease w-full rounded-md border ${
                formErrors.mobile ? 'border-error-main' : 'border-gray-light'
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            rows="3"
            className={`ease w-full rounded-md border ${
              formErrors.user_message ? 'border-error-main' : 'border-gray-light'
            } bg-transparent px-3 py-2 text-sm transition duration-300 placeholder:text-gray-main hover:border-gray-main focus:border-gray-main focus:outline-none`}
