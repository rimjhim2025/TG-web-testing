  ...
  return (
    <>
      {isMobile ? (<>
                ...
                <div className="bg-white rounded-lg shadow-main ">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <span className="mb-1 font-bold text-2xl text-black">
                          3.2<span className="text-primary">Cr+</span>
                        </span>
                        <p className="font-medium text-xs text-black">Yearly Page Views</p>
                      </div>
                    </div>
                  ...
                  <div className="px-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <span className="mb-1 font-bold text-2xl text-black">
                          182<span className="text-primary">Cr+</span>
                        </span>
                        <p className="font-medium text-xs text-black">Yearly Impressions on Google</p>
                      </div>
                    </div>
                    {/* Custom width border-bottom */}
                    <div className="mt-4 h-px w-full mx-auto bg-green-lightest" />
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <span className="mb-1 font-bold text-2xl text-black">
                          3.65<span className="text-primary">L+</span>
                        </span>
                        <p className="font-medium text-xs text-black">Yearly Leads Generated</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <>
          <section className="relative h-96 md:h-[28rem] w-full lg:mt-[159px]">
            {/* Banner Image */}
            <Image
            ...
            />
            {/* Overlay with Centered Content */}
            <div className="absolute inset-0 bg-black/50 flex items-start justify-center pt-10 md:pt-44">
              <div className="text-center text-white space-y-4  max-w-4xl mx-auto">
                <h2 className="text-2xl  lg:text-4xl mx-auto font-bold leading-snug max-w-3xl">
                  Tractor Gyan is India’s leading platform for tractor and farm equipment information,
                  dedicated to empowering Indian farmers.
                </h2>
                <MainButton text={" Learn More"} />
