...
const baseSocialStats = [
    ...
    },
    {
        ...
        mobilePosition: 'top-[45%] left-[2%]',
        desktopPosition: 'top-[45%] left-[0%]',
        size: 'w-24 h-24 sm:w-24 sm:h-24 md:w-36 md:h-36',
    },
    {
        id: 3,
        label: 'Facebook',
        ...
        mobilePosition: 'top-[0%] left-[45%]',
        desktopPosition: 'top-[-7%] left-[60%] -translate-x-1/2',
    ...
    },
    {
        ...
        textColor: 'text-white',
        mobilePosition: 'bottom-[5%] left-[38%]',
...
const ExtendedSection = async ({ isMobile, currentLang }) => {
    ...
    return (
        <section className="bg-white px-4 sm:pt-4 md:px-12 md:pt-10">
            <div
                className={`container mx-auto flex ${isMobile ? 'flex-col' : 'flex-row'} items-center justify-between gap-y-4 md:gap-x-10`}
            >
                {/* Left Content */}
                <div className="md:justify-just flex w-full justify-center md:w-1/2">
                    <div className="max-w-xl">
                        <h2 className={`font-bold text-black ${isMobile ? 'mb-2 text-xl' : 'mb-4 text-3xl'}`}>
                            Our Extended Family
                        </h2>

                        <p className="text-justify text-base font-medium leading-relaxed text-black md:text-lg">
                            At <span className="font-semibold text-primary">Tractor Gyan</span>, we don’t just see
                            our users as followers—we see you as part of our extended family.
                        </p>

                        <p className="mt-2 text-justify text-base font-medium leading-relaxed text-black md:mt-3 md:text-lg">
                            Since our journey began, our goal has been to simplify and empower Indian agriculture
                            through accurate, unbiased, and up-to-date tractor and farming information. Over time,
                            this mission has grown stronger, thanks to the incredible community that supports,
                            interacts, and grows with us every day.
                        </p>
                    </div>
                </div>
                ...
                <div className={`w-full ${!isMobile ? 'md:w-1/2' : ''} flex justify-center`}>
                    <div
                        className={`relative ${isMobile ? 'h-[340px] w-[380px]' : 'h-[320px] w-[320px] md:h-[480px] md:w-[569px]'}`}
                    >
                        <Image
                        ...
                        {finalStats.map(item => {
                            const platformIconMap = {
                                ...
                                Threads:
                                    'https://images.tractorgyan.com/uploads/120200/6881e5508e2d3-transparent-threads-icon.webp', // fallback to your existing one
                            ...
                            const iconClass = isMobile
                                ? ' h-auto max-w-8 w-auto min-h-7  max-h-8'
                                : 'w-[42px] h-[42px] md:w-12 md:h-12 ';

                            const textColor = ['Instagram', 'Threads'].includes(item.label)
                                ? 'text-white'
                                : 'text-white';
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span
                                        className={`${isMobile ? 'text-[9px]' : 'text-[10px] md:text-sm'} mt-1 font-medium`}
                                    >
                                        {item.label}
                                    </span>
                                </div>
