                ...
                <section className=" bg-white px-4 pb-20 relative">
                    <div className="container max-w-full">
                        ...
                        <div className="relative ">
                            ...
                            <div className="absolute left-0 top-[90px] bottom-[90px] ml-[20px] w-[6px] bg-green-mid rounded-[80px] z-0" />
                                    ...
                                    <div key={index} className="relative flex items-center">
                                        ...
                                        <div className="ml-4  w-full">
                                            <div className="border border-green-lightest rounded-2xl p-2 w-full max-w-none text-left">
                                                <h3 className="text-2xl mt-2 font-bold text-black">{item.year}</h3>
                ...
                <>
                    <section className=" bg-white px-12 relative">
                        <div className="container max-w-full">
                            ...
                            <div className="relative ">
                                {/* Center vertical line */}
                                <div className="absolute left-1/2 top-[80px] bottom-[80px] -translate-x-1/2 w-[6px] bg-green-mid rounded-[80px] z-0" />
                                                ...
                                                {isLeft ? (
                                                    <>
                                                        <div className="md:w-[45%] flex justify-end">
                                                            <div className="border border-green-lightest rounded-2xl p-4 w-full max-w-none text-right">
                                                                <h3 className="text-4xl mt-2 font-bold text-black">{item.year}</h3>
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="md:w-[45%] flex justify-start">
                                                            <div className="border border-green-lightest rounded-2xl p-4 w-full max-w-none text-left">
                                                                <h3 className="text-4xl mt-2 font-bold text-black">{item.year}</h3>
                                                                <p className="font-semibold text-2xl text-black">{item.title}</p>
                                                                <p className="text-base font-normal text-black mt-1">{item.desc}</p>
                                                                <p className="text-base font-normal text-black mt-1">{item.desc1}</p>
                        ...
                        {/* Bottom-left tractor image */}
                        <div className="hidden md:block absolute  -bottom-2 left-0 z-0">
                            <Image
                                src="https://images.tractorgyan.com/uploads/120170/6880c29077a5c-tractor-gyan-monogram.webp"
                                alt="Tractor"
                                width={300}
