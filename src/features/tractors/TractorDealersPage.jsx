  ...
  try {
    if (url_slug == 'tractor-dealers-in-india') {
      ...
      seoHtmlDescription = await getDetailPageHeaderSEO({
        ...
        page_slug: 'tractor-dealers/' + url_slug,
        lang: currentLang,
      });
    }
  } catch (error) {
  ...
  return (
    <main className="pt-4">
      ...
      <DealerFilterSection
        ...
        tyreBrands={allTractorBrands} // Use tractor brands instead of tyre brands
        states={states}
        suggestedDealers={suggestedDealers?.data || []}
        currentLang={currentLang}
        routeSlug={url_slug == 'tractor-dealers-in-india' ? [] : url_slug.split('/')}
        dealerType="tractor" // Add dealer type to distinguish between tyre and tractor
        urlSlug="tractor-dealers-in-india"
      />
      {/* <DealershipRegistrationForm translation={translation} dealerType="tractor" /> */}
      ...
      <WhatsAppTopButton
        translation={translation}
        currentLang={currentLang}
        tyreBrands={allTractorBrands} // Use tractor brands
