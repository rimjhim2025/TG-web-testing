...
const FeedBackForm = ({ isMobile, translation, bgColor }) => {
  ...
  const handleSubmit = async event => {
    ...
    try {
      ...
      if (response.status === 'success') {
        setUserSuccessMsg(
          `Thank you for reaching out to us. Our team will connect with you shortly regarding your query.`
        );
        setShowVerifyMessage(false);
  ...
  return (
    <section className={`${bgColor ? bgColor : ''} lg:mt-[159px] ${isMobile ? '-my-6 pt-8' : ''}`}>
      <div className="container">
        ...
        {isMobile ? (
          <>
            <div className="grid grid-cols-1 items-center md:mx-16 md:grid-cols-2">
              <div className="flex justify-between gap-2.5">
                <div className="h-[81px] w-[63px] min-w-[63px]">
                  <Image
                ...
                <div>
                  <h1 className="text-xl font-bold text-black">Got a question or A Feedback?</h1>
              ...
              <div className="shadow rounded-2xl bg-white p-3 md:p-8">
                <form className="space-y-4" onSubmit={handleSubmit}>
                  ...
                  <div className="termsParaOfRegister mt-4">
                    ...
                    <span>
                      ...
                      <Link href="/terms-of-use">{translation?.signInForm?.termsLinkText}</Link>
                    </span>
                  </div>
                  {errors.terms && <span className="error-message">{errors.terms}</span>}

                  <div className="flex justify-center">
                    <TG_Button type="submit" className="w-full px-6 py-2 text-base md:w-auto">
                      Submit
                    </TG_Button>
                  </div>
                </form>
            ...
            <div className="mx-2 md:mx-16">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 items-center gap-2 md:grid-cols-2">
                  ...
                  <ConnectUsSection isMobile={isMobile} sectionbg={'bg-white'} />
                </div>
              </div>
            </div>
          </>
