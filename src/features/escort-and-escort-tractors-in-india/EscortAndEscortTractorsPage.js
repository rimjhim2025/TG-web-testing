...
export default async function EscortAndEscortTractorsPage({ searchParams, isSeriesListing = false,
    seriesName = null,
    hpRange = null,
    hpTitle = null }) {
    ...
    const brandName = currentLang === "hi" ? 'एस्कॉर' : 'Escorts';
    ...
    return (
        <>
            <SeoHead
                ...
                preloadUrls={[]}
                paginationLinks={{
                    canonical: `${apiUrl}${currentLang === 'hi' ? '/hi' : ''}/escorts-tractors-in-india`,
                }}
            />
            <DesktopHeader
                isMobile={isMobile}
