  ...
  return (
    <div className="mt-0 w-full py-6 lg:mt-6 lg:py-2">
      <div className="mb-6 text-start lg:mb-10">
        <h1 className="mb-3 text-lg font-bold leading-tight text-black md:text-3xl lg:mb-2">
          ...
          >
            <div className="mb-4 flex justify-center lg:mb-6 lg:justify-start">
              <Image
                ...
                title={benefit.title}
                alt={benefit.title}
                className="rounded-t-lg sm:rounded-t-xl lg:rounded-t-2xl"
              />
            </div>

            <div className="p-4">
              <div className="mb-3 text-center lg:mb-1 lg:text-left">
              ...
              <p className="text-center text-sm font-bold leading-relaxed text-black lg:text-left">
                {benefit.description}
              </p>
            </div>
          </div>
