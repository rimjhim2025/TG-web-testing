...
const menuItems = [
  {
    ...
    label: 'Tractor',
    normalImg: 'https://images.tractorgyan.com/uploads/119925/1752040270Mobile-Menu-Tractor.webp',
    activeImg:
  ...
  },
  {
    ...
    match: pathname => pathname.startsWith('/tractor-implements-in-india'),
  },
  {
    ...
    label: 'Tyres',
    normalImg: 'https://images.tractorgyan.com/uploads/119929/1752040328Mobile-Menu-Tyres.webp',
    activeImg:
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center justify-evenly ${
                isActive ? 'rounded-xl bg-primary px-2 pb-1' : ''
              }`}
            >
              <Image
