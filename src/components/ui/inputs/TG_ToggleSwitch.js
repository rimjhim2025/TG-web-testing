  ...
  return (
    <div className="flex items-center space-x-3">
      <button
        ...
        className={`${trackColor} ${trackVariant} w-12 flex items-center rounded-full border border-section-gray shadow-bottom transition-colors duration-300 ${
          isHidden ? 'justify-end' : 'justify-start'
        }`}
      >
